...
- **Dividir metadados de anexos reduz o custo de armazenamento em ordens de magnitude mas cria dois sistemas que podem discordar** — uma linha de metadados apontando para um objeto que nunca foi totalmente escrito, ou um objeto órfão cuja linha foi excluída, ambos exigem reconciliação; colocar um blob de 25 MB no armazenamento de linhas em vez disso os manteria atômicos e destruiria sua latência de leitura e taxa de acerto de cache.
