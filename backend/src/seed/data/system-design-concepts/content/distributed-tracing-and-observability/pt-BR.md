...
description: Por que uma requisição que se ramifica através de dezenas de serviços não pode ser depurada apenas com logs e dashboards, e como um trace — uma árvore de spans causalmente ordenada carregando um único contexto através de cada salto — responde "para onde foi o tempo e o que realmente aconteceu" para uma requisição específica.
difficulty: Advanced
readingTime: 15
tags:
  - Observabilidade
