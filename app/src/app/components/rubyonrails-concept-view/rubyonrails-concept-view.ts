...
import { RubyOnRailsConcept } from '../../models/rubyonrails-concept.model';
...
@Component({
  selector: 'app-rubyonrails-concept-view',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [RenderMermaidDirective, RenderConceptVizDirective, ConceptActions, RouterLink, Breadcrumbs],
  templateUrl: './rubyonrails-concept-view.html',
})
export class RubyOnRailsConceptView extends DeepDiveConceptView implements OnChanges {
  concept = input<RubyOnRailsConcept | null>(null);
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.activeDeepDiveId.set(null);
    this.relatedItems.set(concept.related.map((ref) => toConceptLinkItem(ref, 'rubyonrails-concepts')));
  }
}
